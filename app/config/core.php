 ...
 */
	Configure::write('Session.cookie', 'www.llevatelos.com');

/**
 * Session time out time (in seconds).
 * Actual value depends on 'Security.level' setting.
 */
	Configure::write('Session.timeout', '220');
 ...
 */
	Configure::write('Security.salt', 'KwajaLEIN4334LEINKwaja');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '1982060909061982870315150387');
