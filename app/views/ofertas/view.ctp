...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Oferta', true), array('action' => 'edit', $oferta['Oferta']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Oferta', true), array('action' => 'delete', $oferta['Oferta']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $oferta['Oferta']['id'])); ?> </li>
