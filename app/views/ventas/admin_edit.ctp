...
<?php echo $this->Form->create('Venta');?>
	<fieldset>
 		<legend><?php __('Modificar La Venta'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<i>
			<li><?php echo $this->Html->link(__('Eliminar La Venta', true), array('action' => 'delete', $this->Form->value('Venta.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Venta.id'))); ?></li>
		</i>
