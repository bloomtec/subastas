<div class="configs index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('tamano_cola');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $config['Config']['tamano_cola']; ?>&nbsp;</td>
		<td><?php echo $config['Config']['created']; ?>&nbsp;</td>
		<td><?php echo $config['Config']['updated']; ?>&nbsp;</td>
		<td class="actions">
