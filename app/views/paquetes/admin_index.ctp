<div>
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			...
			<?php echo $this->Html->link(__('Editar', true), array('action' => 'edit', $paquete['Paquete']['id'])); ?>
			<?php echo $this->Html->link(__('Borrar', true), array('action' => 'delete', $paquete['Paquete']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $paquete['Paquete']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
