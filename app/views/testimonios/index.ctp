<div class="testimonios index">
	...
	<!-- 	<h3><?php __('Actions'); ?></h3> -->
		<ul>
			<li><?php echo $this->Html->link(__('Agregue Su Testimonio', true), array('action' => 'add')); ?></li>
		</ul>
	</div>
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			...
			<?php echo $this->Html->link(__('Eliminar', true), array('action' => 'delete', $testimonio['Testimonio']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $testimonio['Testimonio']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
