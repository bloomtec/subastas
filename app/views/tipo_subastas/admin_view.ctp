<div class="tipoSubastas view">
<h2><?php  __('Tipo Subasta');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Id'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $tipoSubasta['TipoSubasta']['id']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Nombre'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $tipoSubasta['TipoSubasta']['nombre']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Created'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $tipoSubasta['TipoSubasta']['created']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php __('Updated'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $tipoSubasta['TipoSubasta']['updated']; ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Tipo Subasta', true), array('action' => 'edit', $tipoSubasta['TipoSubasta']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Tipo Subasta', true), array('action' => 'delete', $tipoSubasta['TipoSubasta']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $tipoSubasta['TipoSubasta']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($tipoSubasta['Subasta'])):?>
	...
	<?php
		$i = 0;
		foreach ($tipoSubasta['Subasta'] as $subasta):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
