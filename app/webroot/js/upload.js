		...
		function() {
			...
			$('#upload').uploadify({
				...
				'onComplete' : function(a, b, c, d) {
					/*
					 * var name=c.name; $(".selectImagePath").append('<option
					 * value="productos/'+name+'" selected="selected">'+name+'</option>');
					 * $(".product_image").html('<img width="300px"
					 * src="'+server+'img/productos/'+name+'" />');
					 */
				}
			});
