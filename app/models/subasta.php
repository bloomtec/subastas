...
class Subasta extends AppModel {
	...
	var $belongsTo = array(
		...
		'EstadosSubasta' => array(
			'className' => 'EstadosSubasta',
			'foreignKey' => 'estados_subasta_id',
			'conditions' => '',
			'fields' => '',
			'order' => ''
		)
    ...
    foreach ($results as $key => $val) {
		...
		/*
			...
			*/
			...
			$results[$key]['Subasta']['faltante_timestamp'] = $serverDate." => ".$endDate;//$faltanteTimeStamp;
